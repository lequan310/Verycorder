import React, { useState, useContext, useEffect, LegacyRef } from "react";
...
const AddEvent = React.forwardRef<HTMLDivElement, AddEventProps>(
  ({ addEvent, addCanvasEvent }, ref) => {
